...
const Home = () => {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['<i>Tailwind</i> CSS.', '&amp; Typescript','React'],
      typeSpeed: 50,
    });
  ...
  return (
   <main>
    ...
    Unlock <span className="font-semibold">the World of Coding </span> with Expert Tutorials, Insights, and Resources  using <span className="font-semibold underline decoration-primary"> <span ref={el} /></span></h1> <p className="mt-4 text-md text-gray-500 dark:text-gray-300">Welcome to our website, your go-to destination for all things coding! Our blog is dedicated to providing in-depth tutorials,helpful <br className="hidden lg:block"/>resources,and expert insights on various programming languages, frameworks, and development tools.</p> <div className="mt-6 bg-transparent border rounded-lg dark:border-gray-700 lg:w-2/3 focus-within:border-primary focus-within:ring focus-within:ring-primary dark:focus-within:border-primary focus-within:ring-opacity-20"><form action="https://www.creative-tim.com/twcomponents/search" className="flex flex-wrap justify-between md:flex-row">
  ...
  <h1 className=" text-center font-bold py-4 text-primary text-4xl ">About Our Services</h1>
